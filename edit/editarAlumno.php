        ...
        <div class="form-label-group">
          <div class="row my-4">
            ...
            <div class="col-sm-4">
              ...
              <input type="input-nombres" class="form-control" placeholder="nombres">
              <label for="input-Apellidos">Apellidos</label>
              <input type="input-Apellidos" class="form-control" placeholder="apellidos">
              <label for="input-nLista">Número de Lista</label>
              <input type="input-nLista" class="form-control" placeholder="nLista">
            </div>
            <div class="col-sm-4">
              <label for="input-escuela">Escuela</label>
              <input type="input-escuela" class="form-control" placeholder="escuela">
              <label for="input-grado">Grado</label>
              <input type="input-grado" class="form-control" placeholder="grado">
              <label for="input-grupo">Grupo</label>
              <input type="input-grupo" class="form-control" placeholder="grupo">
            </div>
            <div class="col-sm-2"></div>
          </div>
        </div>
