        ...
        <div class="form-label-group">
          <div class="row my-4">
            ...
            <div class="col-sm-4">
              ...
              <input type="input-nombre" class="form-control" placeholder="nombre">
              <label for="input-numero">Número</label>
              <input type="input-numero" class="form-control" placeholder="numero">
              <label for="input-turno">Turno</label>
              <input type="input-turno" class="form-control" placeholder="turno">
              <label for="input-localidad">Localidad</label>
              <input type="input-localidad" class="form-control" placeholder="localidad">
            </div>
            <div class="col-sm-2"></div>
          </div>
        </div>
